...
class CraftsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create craft" do
    assert_difference('Craft.count') do
      post crafts_url, params: { craft: { pdtCategory: @craft.pdtCategory, pdtImg: @craft.pdtImg, pdtName: @craft.pdtName, pdtPrice: @craft.pdtPrice } }
    end
  ...
  test "should update craft" do
    patch craft_url(@craft), params: { craft: { pdtCategory: @craft.pdtCategory, pdtImg: @craft.pdtImg, pdtName: @craft.pdtName, pdtPrice: @craft.pdtPrice } }
